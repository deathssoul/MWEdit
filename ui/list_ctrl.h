...
class CEsmListCtrl : public CListCtrl {
  ...
  public:
	...
	void SetCheck(const int Item, const bool Flag) {
		ListView_SetCheckState(m_hWnd, Item, Flag);
	}
	...
	void SetEnableDrag(const bool Flag) {
		m_EnableDrag = Flag;
	}

	void SetAcceptDrag(const bool Flag) {
		m_AcceptDrag = Flag;
	}

	void SetWantKeys(const bool Flag) {
		m_WantKeys = Flag;
	}

	void SetWantEditMsg(const bool Flag) {
		m_WantEditMsg = Flag;
	}

	void SetActNormal(const bool Flag) {
		m_ActNormalList = Flag;
	}

	void SetWantSortMsg(const bool Flag) {
		m_WantSortMsg = Flag;
	}
