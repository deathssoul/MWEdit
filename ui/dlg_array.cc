...
static esmdlgcreateinfo_t l_EsmDlgCreateInfo[] = {
	{
		MWESM_REC_ACTI,
		_T("Activator"),
		CEsmActivatorDlg::IDD,
		RUNTIME_CLASS(CEsmActivatorDlg),
	...
	},
	{
		MWESM_REC_APPA,
		_T("Apparatus"),
		CEsmApparatusDlg::IDD,
		RUNTIME_CLASS(CEsmApparatusDlg),
		RUNTIME_CLASS(CChildFrameFix),
		NULL
	},
	{
	...
	},
	{
		MWESM_REC_BSGN,
		_T("Birth Sign"),
		CEsmBirthSignDlg::IDD,
		RUNTIME_CLASS(CEsmBirthSignDlg),
		RUNTIME_CLASS(CChildFrameFix),
		NULL
	},
	{
	...
	},
	{
		...
		_T("Dialogue"),
		CEsmDialogDlg::IDD,
		RUNTIME_CLASS(CEsmDialogDlg),
		RUNTIME_CLASS(CChildFrameVar),
		&CEsmDlgHandler::CreateDialogueDlg
	},
	{
		MWESM_REC_DOOR,
		_T("Door"),
		CEsmDoorDlg::IDD,
		RUNTIME_CLASS(CEsmDoorDlg),
		RUNTIME_CLASS(CChildFrameFix),
		NULL
	},
	{
	...
	},
	{
		MWESM_REC_INGR,
		_T("Ingredient"),
		CEsmIngrediantDlg::IDD,
		RUNTIME_CLASS(CEsmIngrediantDlg),
		RUNTIME_CLASS(CChildFrameFix),
		NULL
	},
	{
		MWESM_REC_LEVC,
		_T("Level Creature"),
		CEsmLevelCreaDlg::IDD,
		RUNTIME_CLASS(CEsmLevelCreaDlg),
		RUNTIME_CLASS(CChildFrameFix),
		NULL
	},
	{
		MWESM_REC_LEVI,
		_T("Level Item"),
		CEsmLevelItemDlg::IDD,
		RUNTIME_CLASS(CEsmLevelItemDlg),
		RUNTIME_CLASS(CChildFrameFix),
		NULL
	},
	{
	...
	},
	{
		...
		_T("Script"),
		CEsmScriptDlg::IDD,
		RUNTIME_CLASS(CEsmScriptDlg),
		RUNTIME_CLASS(CChildFrmScript),
		NULL
	},
	{
		MWESM_REC_GMST,
	...
	},
	{
		MWESM_REC_SSCR,
		_T("Start Script"),
		CEsmStartScriptDlg::IDD,
		RUNTIME_CLASS(CEsmStartScriptDlg),
		RUNTIME_CLASS(CChildFrameFix),
		NULL
	},
	{
...
static esmdlgcreateinfo_t l_EsmScriptCompareCreateInfo = {
	NULL,
	_T("Script Comparison"),
	CEsmScriptCompareDlg::IDD,
	RUNTIME_CLASS(CEsmScriptCompareDlg),
	RUNTIME_CLASS(CChildFrameFix),
	NULL
};
...
CFrameWnd *CEsmDlgHandler::CreateESMDialog(esmdlgcreateinfo_t &CreateInfo) {
	...
	pFrame->LoadFrame(CreateInfo.ResourceID,
	                  WS_OVERLAPPEDWINDOW,
	                  NULL,
	                  &Context);
	return pFrame;
