...
class CMWEditView : public CFormView {
  ...
  public:
	...
	void FillJournalList(esmcoldata_t *pColData) {
		FillDialogueList(pColData, MWESM_DIALTYPE_JOURNAL);
	}

	void FillVoiceList(esmcoldata_t *pColData) {
		FillDialogueList(pColData, MWESM_DIALTYPE_VOICE);
	}

	void FillGreetingList(esmcoldata_t *pColData) {
		FillDialogueList(pColData, MWESM_DIALTYPE_GREETING);
	}

	void FillPersuasionList(esmcoldata_t *pColData) {
		FillDialogueList(pColData, MWESM_DIALTYPE_PERSUASION);
	}
