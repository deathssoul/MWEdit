...
bool CEsmOptions::ReadFromRegistry() {
	...
	SetExtraFile(Buffer);
	Buffer = pApp->GetProfileString(ESMSCR_REGSEC_SCRIPT,
	                                ESMSCR_REGENTRY_SCRIPTINDENTSTRING,
...
bool CEsmOptions::WriteToRegistry() {
	...
	int iResult;
	/* General options */
	iResult = pApp->WriteProfileString(ESMSCR_REGSEC_GENERAL,
	                                   ESMSCR_REGENTRY_AUTHORNAME,
	                                   m_AuthorName);
	iResult &= pApp->WriteProfileString(ESMSCR_REGSEC_GENERAL,
	                                    ESMSCR_REGENTRY_DATAPATH,
	                                    m_DataPath);
	...
	iResult &= pApp->WriteProfileInt(ESMSCR_REGSEC_SCRIPT,
	                                 ESMSCR_REGENTRY_INITIALINDENTLEVEL,
	                                 m_InitialIndentLevel);
	iResult &= pApp->WriteProfileInt(ESMSCR_REGSEC_SCRIPT,
	                                 ESMSCR_REGENTRY_INDENTCOMMENTSMORE,
	                                 m_IndentCommentsMore);
	iResult &= pApp->WriteProfileInt(ESMSCR_REGSEC_SCRIPT,
	                                 ESMSCR_REGENTRY_NOSCRFORMAT,
	                                 m_NoScriptFormat);
	iResult &= pApp->WriteProfileInt(ESMSCR_REGSEC_SCRIPT,
