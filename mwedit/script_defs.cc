...
int GetESMScriptOpToken(const TCHAR *pString) {
	...
	if (pString[1] == NULL_CHAR) {
		switch (pString[0]) {
			case '(':
				return ESMSCR_TOKEN_OPENBRAC;

			case ')':
				return ESMSCR_TOKEN_CLOSEBRAC;

			case '+':
			case '-':
				return ESMSCR_TOKEN_ADDOP;

			case '*':
			case '/':
				return ESMSCR_TOKEN_MULOP;
			...
			case '.':
				return ESMSCR_TOKEN_VAROP;

			case ',':
				return ESMSCR_TOKEN_COMMA;
...
const TCHAR *GetESMTokenName(const int Token) {
	switch (Token) {
		case ESMSCR_BEGINBLOCK:
			return _T("Begin Block");

		case ESMSCR_ENDTABLE:
			return _T("End Table");

		case ESMSCR_TOKEN_UNKNOWN:
			return _T("Unknown");

		case ESMSCR_TOKEN_INTEGER:
			return _T("Integer");

		case ESMSCR_TOKEN_FLOAT:
			return _T("Float");
		...
		case ESMSCR_TOKEN_OPERATOR:
			return _T("Operator");

		case ESMSCR_TOKEN_EOL:
			return _T("End-of-Line");

		case ESMSCR_TOKEN_EOS:
			return _T("End-of-File");

		case ESMSCR_TOKEN_BEGIN:
			return _T("begin");

		case ESMSCR_TOKEN_END:
			return _T("end");

		case ESMSCR_TOKEN_TYPEOP:
			return _T("Type");

		case ESMSCR_TOKEN_SET:
			return _T("set");

		case ESMSCR_TOKEN_TO:
			return _T("to");
		...
		case ESMSCR_TOKEN_RELOP:
			return _T("Compare Operator");

		case ESMSCR_TOKEN_IF:
			return _T("if");

		case ESMSCR_TOKEN_ELSEIF:
			return _T("elseif");

		case ESMSCR_TOKEN_ELSE:
			return _T("else");

		case ESMSCR_TOKEN_ENDIF:
			return _T("endif");

		case ESMSCR_TOKEN_WHILE:
			return _T("while");

		case ESMSCR_TOKEN_ENDWHILE:
			return _T("endwhile");

		case ESMSCR_TOKEN_RETURN:
			return _T("return");

		case ESMSCR_TOKEN_GET:
			return _T("get");
		...
		case ESMSCR_TOKEN_FUNCOP:
			return _T("->");

		case ESMSCR_TOKEN_VAROP:
			return _T(".");
